;Dragon --- The Dragon Operating System Kernel
;===================================================================
...
os_main:
	...
	mov es, ax			; segments ever again, as DRAGONOS and its programs
...
option_screen:
	...
	os_init_msg		db '*************************Welcome to DRAGON OS****************************', 0
	os_version_msg		db 'Version ', DRAGONOS_VER, 0
